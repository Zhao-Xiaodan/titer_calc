...
df = selectParticipantByCount(df, 2)
...
pp_list = [15]
condition = (dataFrame_fVaccinated['Days from 2nd Jab'] > 0) &\
            (dataFrame_fVaccinated['Days from 2nd Jab'] < 5*7) &\
            (dataFrame_fVaccinated['Participant'].isin(pp_list))
dataFrame_fVaccinated =  dataFrame_fVaccinated.loc[~condition]
